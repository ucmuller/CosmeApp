<template>
  <v-container class="wrap pt-0 px-0 pb-0">
    ...
    >
      ...
      >
        <p
          class="ma-0 font-weight-bold label-summer"
        >
          # 夏タイプ
        </p>
        <p
        ...
        >
          夏タイプは青みを含んだ冷たさが感じられる「ブルーベース」の色グループです。淡く薄く柔らかなしっとりとした色と相性が良いです。控えめでエレガントな感じが魅力ですが、おしゃれでモダンなスタイルも似合います。
        </p>
        <div
          class="text-h7 font-weight-bold"
        >
        ...
        >
          優しいパステルなカラーや初夏に咲く紫陽花のように淡くてソフトな色味、スモーキーな雲や白く霞んだ空の色、ベビーピンク、ミントグリーンなどが似合います。
        </p>
      </v-col>
      <v-col
        cols="12"
      ...
      >
        ...
        >
          夏タイプの人のメイクのポイントは透明感です。控えめで上品な色を使用しコントラストをつけずにグラデーションを意識すると良いです。明るく鮮やかな色よりワントーン落ち着いた色や少し紫の入ったモーブピンクやローズピンクがおすすめです。
        </p>
      </v-col>
      <v-col
        cols="12"
      ...
      >
        ...
        <CarouselVueFlickity
          :handle-products="summerCosmeEye"
        />
      </v-col>
      <v-col
        cols="12"
      ...
      >
        ...
        <CarouselVueFlickity
          :handle-products="summerCosmeCheek"
        />
      </v-col>
      <v-col
        cols="12"
      ...
      >
        ...
        <CarouselVueFlickity
          :handle-products="summerCosmelip"
        />
      </v-col>
      <v-col
        cols="12"
      ...
      >
        ...
        >
          <v-slide-item
            v-for="(item, i) in summerYoutuber"
            :key="i"
          >
            <v-card
              class="ma-1 pa-1"
        ...
        <div class="pr-2 text-right">
          <p
            class="ma-0 link"
            @click="pushToSortedChannelList('夏')"
          >
            夏タイプのYouTuberをもっと見る
            <v-icon
              color="#2A5FA6"
      ...
      >
                ...
                <v-list-item-content class="pa-2">
                  <v-row align="center">
                    ...
                    >
                      ...
                      size="30"
                      left
                      @click="pushToChannelPage(videos[1].channelId)"
                    >
                      <v-img
                ...
                <v-list-item-content class="pa-2">
                  <v-row align="center">
                    ...
                    >
                      ...
                      size="30"
                      left
                      @click="pushToChannelPage(videos[2].channelId)"
                    >
                      <v-img
                ...
                <v-list-item-content class="pa-2">
                  <v-row align="center">
                    ...
                    >
                      ...
                      size="30"
                      left
                      @click="pushToChannelPage(videos[3].channelId)"
                    >
                      <v-img
        ...
        <div class="pr-2 text-right">
          <p
            class="ma-0 link"
            @click="pushToSortedVideoListlPage('夏')"
          >
            夏タイプの動画をもっと見る
            <v-icon
              color="#2A5FA6"
...
export default Vue.extend({
  ...
  data: () => ({
    imageSummer: require('@/assets/images/img_summer.jpg'),
    imageColorSummer: require('@/assets/images/color_summer_clothes.png'),
    channels: [] as any,
    summerCosmeEye: [] as any,
    summerCosmeCheek: [] as any,
    summerCosmelip: [] as any,
    summerYoutuber: [] as any,
    videos: [] as any,
    flickityOptions: {
      pageDots: false,
  ...
  methods: {
    ...
    fetchSummerCosmeData(): void {
      ...
      .then((querySnapShot) => {
        querySnapShot.forEach(doc =>{
          this.summerCosmeEye.push(doc.data())
        })
      })
      DB.collection('products')
      .where('categoryId', '==', "16" )
      ...
      .then((querySnapShot) => {
        querySnapShot.forEach(doc =>{
          this.summerCosmeCheek.push(doc.data())
        })
      })
      DB.collection('products')
      .where('categoryId', '==', "57" )
      ...
      .then((querySnapShot) => {
        querySnapShot.forEach(doc =>{
          this.summerCosmelip.push(doc.data())
        })
      })
      ...
      .then((querySnapShot) => {
        querySnapShot.forEach(doc =>{
          this.summerYoutuber.push(doc.data())
        })
      })
    },
